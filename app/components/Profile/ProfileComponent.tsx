...
function ProfileComponent() {
  return (
    <div className="size-full">
      <div className="relative overflow-hidden border border-white/35 bg-white backdrop-blur-md backdrop-filter">
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2 className="text-xl block  font-bold text-black ">
                  Jennie Shrestha
                </h2>
                <p className="text-black">jennie@gmail.com</p>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center">
              ...
              <p className="mt-1 text-2xl font-bold text-black">10K</p>
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-black">Avg. Order Value</p>
            </div>
            <div className="text-center">
