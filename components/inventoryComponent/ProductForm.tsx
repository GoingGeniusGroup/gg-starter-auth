      ...
      <form  onSubmit={handleSubmit(onsubmit)} className="w-full max-w-5xl bg-white shadow-lg rounded-lg p-6 space-y-6">
        <fieldset className="my-1 border border-blue-500 rounded-lg p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="mb-4">
              <label htmlFor="costPrice" className="block text-sm font-semibold text-gray-700">Cost Price</label>
            ...
            <div className="mb-4">
              <label htmlFor="salePrice" className="block text-sm font-semibold text-gray-700">Sell Price</label>
